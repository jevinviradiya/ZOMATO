                ...
                return listData.map((item)=>{
                    return(
                        <div class="row productbox">
                            <div class="col-lg-5">
                                <a href="singleproduct.html" target=""><img src="/img/foodImages/food5.webp" alt="" width="100%" /></a>
                            </div>
                            <div class="col-lg-7">
                                <div class="othercontent">
                                    <h2 class="foodname"><Link to={`/details?restId=${item.restaurant_id}`} target= "">{item.restaurant_name}</Link></h2>
